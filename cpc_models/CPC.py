...
class CPC(nn.Module):
    ...
    def __init__(self, encoderNet, arNet, pred_directions, pred_steps, neg_samples,  version, head_size):
        super().__init__()
        ...
        self.pred_loss = nn.ModuleList(
            InfoNCE_Loss(pred_steps=pred_steps, neg_samples=neg_samples, in_channels=encoderNet.encoding_size, version = version, head_size = head_size)
